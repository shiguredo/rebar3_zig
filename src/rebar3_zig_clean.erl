...
init(State) ->
    Provider = providers:create([
            ...
            {short_desc, "A rebar plugin to remove artifacts generated by `$ rebar3_zig zig compile`"},
            {desc, "A rebar plugin to remove artifacts generated by `$ rebar3 zig compile`"}
    ]),
